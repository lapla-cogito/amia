...
pub unsafe fn alloc_pages(n: u32) -> crate::types::PaddrT {
...
pub unsafe fn map_page(
    table1: crate::types::PaddrT,
    vaddr: crate::types::VaddrT,
    paddr: crate::types::PaddrT,
    flags: u32,
) {
    if vaddr % crate::constants::PAGE_SIZE as u32 != 0 {
    ...
    table0.offset(vpn0).write(
        ((paddr / crate::constants::PAGE_SIZE as u32) << 10)
            | flags
            | crate::constants::PAGE_V,
    );
}
